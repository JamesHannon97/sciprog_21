...
program matrixmult
  ...
  !Comment: To improve efficiency, access matrices by column first
  !Example: Change loops so that we iterate over column before row
