...
module subs
  ...
  ! Allocate an array of size n to a pointer to an allocated memory block of that many integers.
  ...
  ! Deallocates the array created and modified in the preceeding functions
